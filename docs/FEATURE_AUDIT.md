...
Generated 2026-07-30 by `tools/build_feature_audit.py`. 
...
| `AtlasBlockoutViewport` | atlas_camera/comfy/nodes_viewport.py | standard | 19 | 14 | not_attempted | not_attempted | 0 | 7 | — | — | — | **KEEP_CORE** | — |
| `AtlasBoundedBand` | atlas_camera/comfy/nodes_depth.py | standard | 1 | 1 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasCleanPlateLayer` | atlas_camera/comfy/nodes_inpaint.py | standard | 6 | 11 | not_attempted | not_attempted | 1 | 6 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDepthDetailEnhance` | atlas_camera/comfy/nodes_depth.py | standard | 1 | 1 | not_attempted | not_attempted | 0 | 1 | — | — | — | **KEEP_CORE** | — |
| `AtlasDepthLayerMask` | atlas_camera/comfy/nodes_depth.py | standard | 2 | 4 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasDepthMap` | atlas_camera/comfy/nodes_depth.py | standard | 13 | 4 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDeriveProjectionGeometry` | atlas_camera/comfy/nodes_geometry.py | standard | 0 | 4 | not_attempted | not_attempted | 0 | 4 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDeriveReliefMesh` | atlas_camera/comfy/nodes_geometry.py | standard | 4 | 10 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDeriveWalls` | atlas_camera/comfy/nodes_geometry.py | standard | 4 | 5 | not_attempted | not_attempted | 0 | 3 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDisocclusionGuide` | atlas_camera/comfy/nodes_viewport.py | standard | 0 | 1 | not_attempted | not_attempted | 0 | 2 | — | — | — | **KEEP_CORE** | — |
| `AtlasEquirectMultiView` | atlas_camera/comfy/nodes_solve.py | standard | 1 | 3 | not_attempted | not_attempted | 0 | 0 | — | — | low — new this cycle, nothing to migrate | **KEEP_CORE** | none; keep |
...
| `AtlasInpaintCrop` | atlas_camera/comfy/nodes_inpaint.py | standard | 3 | 2 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasInpaintStitch` | atlas_camera/comfy/nodes_inpaint.py | standard | 3 | 2 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasInput` | atlas_camera/comfy/nodes_viewport.py | standard | 9 | 5 | not_attempted | not_attempted | 0 | 9 | — | — | — | **KEEP_CORE** | — |
| `AtlasInstanceMask` | atlas_camera/comfy/nodes_inpaint.py | standard | 0 | 1 | not_attempted | not_attempted | 0 | 2 | — | — | — | **KEEP_CORE** | — |
| `AtlasLayerPlan` | atlas_camera/comfy/nodes_completion.py | standard | 2 | 1 | not_attempted | not_attempted | 1 | 0 | — | — | low — new this cycle, nothing to migrate | **KEEP_CORE** | none; keep |
...
| `AtlasLoadPlate` | atlas_camera/comfy/nodes_solve.py | standard | 3 | 2 | ok | ok | 0 | 2 | — | — | low — nothing depended on it before either | **KEEP_CORE** | none; keep |
...
| `AtlasMogeNormals` | atlas_camera/comfy/nodes_depth.py | standard | 1 | 2 | not_attempted | not_attempted | 0 | 1 | — | — | — | **KEEP_CORE** | — |
| `AtlasMoveBudget` | atlas_camera/comfy/nodes_completion.py | standard | 17 | 3 | not_attempted | not_attempted | 1 | 1 | — | — | low — new this cycle, nothing to migrate | **KEEP_CORE** | none; keep |
...
| `AtlasOutpaintDepth` | atlas_camera/comfy/nodes_depth.py | standard | 1 | 1 | not_attempted | not_attempted | 0 | 0 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasSAM3Mask` | atlas_camera/comfy/nodes_inpaint.py | standard | 7 | 4 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasSDXLInpaint` | atlas_camera/comfy/nodes_inpaint.py | standard | 3 | 3 | not_attempted | not_attempted | 0 | 4 | — | — | — | **KEEP_CORE** | — |
| `AtlasScaleOverride` | atlas_camera/comfy/nodes_solve.py | standard | 2 | 2 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasSolveFromImage` | atlas_camera/comfy/nodes_solve.py | standard | 1 | 0 | ok | ok | 1 | 4 | — | — | — | **KEEP_CORE** | — |
| `AtlasSolveGate` | atlas_camera/comfy/nodes_solve.py | standard | 4 | 2 | not_attempted | not_attempted | 2 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasSolvePatchViews` | atlas_camera/comfy/nodes_geometry.py | standard | 0 | 1 | not_attempted | not_attempted | 0 | 1 | — | — | — | **KEEP_CORE** | — |
| `AtlasSplitEquirect` | atlas_camera/comfy/nodes_solve.py | standard | 1 | 1 | not_attempted | not_attempted | 0 | 2 | — | — | low — new this cycle, nothing to migrate | **KEEP_CORE** | none; keep |
| `AtlasStereoRender` | atlas_camera/comfy/nodes_viewport.py | standard | 17 | 3 | ok | ok | 0 | 1 | — | — | low — nothing depended on it before either | **KEEP_CORE** | none; keep |
| `AtlasStreamRecord3D` | atlas_camera/comfy/nodes_solve.py | standard | 0 | 1 | not_attempted | not_attempted | 0 | 1 | — | — | — | **KEEP_CORE** | — |
