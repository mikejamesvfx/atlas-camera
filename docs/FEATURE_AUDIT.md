...
| `AtlasBlockoutMassing` | atlas_camera/comfy/nodes_geometry.py | experimental | 0 | 3 | not_attempted | not_attempted | 0 | 0 | — | — | — | **KEEP_EXPERIMENTAL** | — |
...
| `AtlasDecomposeSolve` | atlas_camera/comfy/nodes_solve.py | standard | 1 | 1 | ok | ok | 0 | 4 | — | — | low — nothing depended on it before either | **KEEP_CORE** | none; keep |
...
| `AtlasDepthMap` | atlas_camera/comfy/nodes_depth.py | standard | 2 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasExportSolveJSON` | atlas_camera/comfy/nodes_export.py | standard | 2 | 0 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasSceneHealthGate` | atlas_camera/comfy/nodes_solve.py | standard | 1 | 1 | not_attempted | not_attempted | 0 | 3 | — | — | — | **KEEP_CORE** | — |
