...
| `AtlasBlockoutViewport` | atlas_camera/comfy/nodes_viewport.py | standard | 4 | 14 | not_attempted | not_attempted | 0 | 7 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDebugReport` | atlas_camera/comfy/nodes_viewport.py | standard | 3 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDepthMap` | atlas_camera/comfy/nodes_depth.py | standard | 8 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDeriveReliefMesh` | atlas_camera/comfy/nodes_geometry.py | standard | 6 | 10 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasExportSolveJSON` | atlas_camera/comfy/nodes_export.py | standard | 7 | 0 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasLearnedSolveFromImage` | atlas_camera/comfy/nodes_solve.py | standard | 8 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasOcclusionGraph` | atlas_camera/comfy/nodes_completion.py | standard | 4 | 4 | not_attempted | not_attempted | 1 | 1 | — | — | low — new this cycle, nothing to migrate | **KEEP_CORE** | none; keep |
