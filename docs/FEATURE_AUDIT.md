...
Generated 2026-09-13 by `tools/build_feature_audit.py`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `AtlasAddPatchView` | atlas_camera/comfy/nodes_geometry.py | standard | 4 | 18 | not_attempted | not_attempted | 1 | 7 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasExportNuke` | atlas_camera/comfy/nodes_export.py | standard | 3 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasFillOccluded` | atlas_camera/comfy/nodes_fill.py | standard | 1 | 3 | not_attempted | not_attempted | 1 | 1 | — | — | — | **KEEP_CORE** | — |
