...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `AtlasAddPatchView` | atlas_camera/comfy/nodes_geometry.py:2618 | standard | 0 | 5 | not_attempted | not_attempted | 0 | 3 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDebugReport` | atlas_camera/comfy/nodes_viewport.py:416 | standard | 3 | 4 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDefineShotCam` | atlas_camera/comfy/nodes_geometry.py:2354 | standard | 0 | 1 | not_attempted | not_attempted | 0 | 3 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasDeriveInteriorRoom` | atlas_camera/comfy/nodes_geometry.py:2226 | standard | 0 | 1 | not_attempted | not_attempted | 0 | 2 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDeriveProjectionGeometry` | atlas_camera/comfy/nodes_geometry.py:49 | standard | 0 | 3 | not_attempted | not_attempted | 0 | 4 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDeriveReliefMesh` | atlas_camera/comfy/nodes_geometry.py:734 | standard | 2 | 6 | not_attempted | not_attempted | 0 | 5 | — | — | — | **KEEP_CORE** | — |
| `AtlasDeriveRoofsFacades` | atlas_camera/comfy/nodes_geometry.py:2182 | standard | 0 | 1 | not_attempted | not_attempted | 0 | 2 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDeriveTowersSpires` | atlas_camera/comfy/nodes_geometry.py:2099 | standard | 0 | 4 | not_attempted | not_attempted | 0 | 2 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
| `AtlasDeriveWalls` | atlas_camera/comfy/nodes_geometry.py:2022 | standard | 1 | 5 | not_attempted | not_attempted | 0 | 3 | — | FIXED 2026-07-27. Previously emitted a projection_backdrop plane even with no valid depth — hardcoded 60 m, invented extents, no way to explain it because th… | — | **KEEP_CORE** | — |
...
| `AtlasExtractAnglePatch` | atlas_camera/comfy/nodes_geometry.py:2400 | experimental | 0 | 2 | not_attempted | not_attempted | 0 | 0 | — | — | — | **KEEP_EXPERIMENTAL** | — |
...
| `AtlasGroundMask` | atlas_camera/comfy/nodes_depth.py:455 | legacy | 0 | 1 | ok | ok | 0 | 3 | AtlasGroundDepthMap, output 1 (ground_mask) | — | low — in no shipping workflow, no test, no MCP consumer | **LEGACY_GATE** | rewire consumers to AtlasGroundDepthMap slot 1; gate the node |
...
| `AtlasImportAnglePatch` | atlas_camera/comfy/nodes_geometry.py:2522 | experimental | 0 | 2 | not_attempted | not_attempted | 0 | 0 | — | — | — | **KEEP_EXPERIMENTAL** | — |
...
| `AtlasMergeGeometry` | atlas_camera/comfy/nodes_geometry.py:2267 | standard | 1 | 3 | not_attempted | not_attempted | 0 | 3 | — | — | — | **KEEP_CORE** | — |
| `AtlasMogeNormals` | atlas_camera/comfy/nodes_depth.py:181 | standard | 0 | 1 | not_attempted | not_attempted | 0 | 1 | — | — | — | **KEEP_CORE** | — |
| `AtlasOcclusionMask` | atlas_camera/comfy/nodes_geometry.py:3143 | standard | 0 | 3 | not_attempted | not_attempted | 0 | 4 | — | — | — | **KEEP_CORE** | — |
| `AtlasPathGuidedHoleRepair` | atlas_camera/comfy/nodes_geometry.py:1685 | standard | 1 | 2 | not_attempted | not_attempted | 1 | 4 | — | — | — | **KEEP_CORE** | — |
| `AtlasPlanarHolePatch` | atlas_camera/comfy/nodes_geometry.py:1305 | standard | 4 | 4 | not_attempted | not_attempted | 0 | 3 | — | — | — | **KEEP_CORE** | — |
...
| `AtlasPredictHiddenGeometry` | atlas_camera/comfy/nodes_geometry.py:381 | experimental | 0 | 3 | not_attempted | not_attempted | 1 | 5 | — | — | — | **KEEP_EXPERIMENTAL** | — |
...
| `AtlasRenderFix` | atlas_camera/comfy/nodes_geometry.py:620 | experimental | 0 | 3 | not_attempted | not_attempted | 1 | 2 | — | — | — | **KEEP_EXPERIMENTAL** | — |
| `AtlasRetopologizeLayer` | atlas_camera/comfy/nodes_geometry.py:1128 | standard | 5 | 2 | not_attempted | not_attempted | 0 | 2 | — | — | — | **KEEP_CORE** | — |
