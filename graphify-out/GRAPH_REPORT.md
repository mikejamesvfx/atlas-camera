...
- Three.js Bundle Core
- Three.js Math Primitives
- ComfyUI Atlas Node Registry
- FBX Loader & Scene Assembly
- Mesh Hole Repair
- Animation Clip Loading
- WebGL Renderer Core
- Solver Benchmark Harness
- VLM Image Assessment
- Node Method Dispatch
- Export-Only Retopology
- Depth Band & Sky Layers
- Multimodal VLM Providers
- Inference Shared Helpers
- Maya Export & Film Units
- Camera Solver Core
- UI Package Dependencies
- DCC Exporter Package
- Atlas Three Bundle
- Schema
- Nodes
- Proxy Geometry
- App
- Nodes
- Vanishing-Point Solve
- Scene Health & Trust
- Blockout Viewport Frontend
- Geometry Attribute Computation
- Relief Mesh Tests
- ComfyUI Adapter & MCP Server
- Scene Health Report Parity
- Depth Estimation Backends
- Geometry Derivation Nodes
- PMREM Environment Prefiltering
- Camera Math & Units
- Three.js Minified Internals
- React Projection Viewport
- Project Manifest
- Clean Plate Stack
- Plate Registration & Export
- Marketing Workflow Generators
- Intrinsics & USD Camera Load
- Patch View Projection
- Hidden Geometry Prediction
- Sky Mask & Camera Validity
- Multimodal Provider Factory
- Relief Mesh Construction
- Confidence Model
- UI Project Analysis
- Proxy Geometry Tests
- Extract Angle & Gates
...
- Occlusion Mask
- Scene Health Gate
- Three.js Texture Conversion
- Learned Prior Solve
- Relief Fill Export Tests
- Reference Scale Measurement
- Relief Mesh Export Helpers
- AtlasInput & Scope Nodes
- RAW Decode
- Agent Guidance Docs
- Scale Reference Registry
- Predicted Normal Alignment
- GeoCalib Learned Prior
- USD Exporter
- TypeScript Config
- Animation Mixer
- Keyframe Interpolants
- Nuke Layers Export
- VLM JSON Recovery
- USD Exporter Tests
- Clean Plate Layer
- Depth Map Nodes
- Depth Band Resolution Tests
- Vector & Quaternion Ops
- MCP HTTP Plumbing
- Fixer Training Pairs
- React Axis Grid
- Band Split Helpers
- Maya Layers Export
- Fixer Render Repair
...
- Generate Showcase Workflows
- Test Scene Type Preset
- Test Scale Override
- Test Solve Gate
...
- Api
- Types
- Test Inpaint Crop Stitch
- Test Exact Patch View
- Test Blender Exporter
- Test Camera Path
- Io
- Test Room Layout
- Test Depth Height
...
- Chart Relmad Backends Svg
- collect_projection_layers
- test_debug_report.py
- Test Ground Anchored Walls
- Test Mcp Comfy Http
- Test Skyline Walls
- Viewport3dstate
- Orbit Stress Test
...
- 2026 07 18 V1 Outlier Stretched Edge Worklog
- Test Depth Estimator Da3
- _layers.py
- camera_path.py
- Install
- Third Party
...
- Smoke Check
- Viewport3dmath
- test_band_geometry_card_is_fronto_parallel_plane
- Test Vlm Scale Cues
- Test Moge Normals Node
- AtlasExtractAnglePatch
- Test Depth Estimator Moge
- Architecture
- Ecosystem Guide
- Atlas Inpaint Layers Design
- Atlas Mcp Server Plan
- Atlas Mesh Repair Solution
- Atlas Wf Composable Pdf
- Atlas Wf Dmp Xray Pdf
- DccExporter
- Test Semantic Segmenter
- Layers
- Undistort
- Atlas Wf Oceancastle Pdf
- Atlas Wf Hangar Pdf
- Atlas Wf Jungleruins Pdf
- Test Debug Report
- User Guide
- Dcc Exports
- User Guide
...
- Atlas Derive Geometry
- test_layer_nodes_expose_shared_quad_coherence_guard
- Validators
- Ecosystem Guide
- Project Vision
- Ecosystem Guide
- Hidden Geometry Training Free Research
- Atlas Wf Portal Pdf
...
- Comfy Workflow
- Dcc Exports
- Da3 Backend Test Plan
- Scene Alpine Village Jpg
- Scene Canyon Jpg
- Scene Cathedral Nave Jpg
- Scene Ghost Town Jpg
- Scene Jungle Temple Jpg
- Scene Monument Valley Jpg
- Scene Mountain Ridge Figure Jpg
- Scene Scifi Hangar Jpg
- Scene Seacliff Castle Jpg
- Scene Snowcapped Peaks Jpg
- Scene Steep Ridge Jpg
- Scene Wide Valley Jpg
- Mcp
- Atlas Camera Icon Png
- Ecosystem Guide
- Publish Comfyui Registry Yml
- Export Depth V2 Onnx
- Generate Atlas Canonical Workflows
- Generate Segmented Sdxl Showcase Workflow
...
- Claude
- Third Party
- Build Raw Hidden Diagnostic
- Build Raw Hidden Inpaint Sdxl
- Build Raw Hidden Inpaint Sdxl Native Api
- Build Raw Hidden Inpaint Tagged
- Build Raw Hidden Segmented Sdxl
- Generate Canonical Trust Workflow
- Claude
- Claude
- Claude
- Readme
...
- **Recover-Derive-Project-Export Pipeline** — docs_user_guide_camera_recovery, docs_ecosystem_guide_geometry_strategies, docs_user_guide_matte_painting_projection, docs_dcc_exports_nuke_projection_topology [INFERRED 0.85]
- **Layered DMP Reconstruction Stack** — docs_ecosystem_guide_five_layer_stack, docs_ecosystem_guide_inpaint_layers, docs_ecosystem_guide_hidden_geometry_track, docs_ecosystem_guide_multi_angle_patch [INFERRED 0.85]
- **Outlier / stretched-edge / black-tear failure taxonomy and its per-class responses** — docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_outlier_failure_class, docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_stretched_edge_failure_class, docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_black_tear_failure_class, docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_atlasdepthoutliermask, docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_quad_coherence_guard, docs_dev_2026_07_18_v1_outlier_stretched_edge_worklog_stretch_diagnostics [EXTRACTED 1.00]
- **ExecutionBlocker gate family with fingerprint-scoped approvals** — docs_dev_gate_state_table_gate_1, docs_dev_gate_state_table_gate_2, docs_dev_gate_state_table_gate_3, docs_dev_gate_state_table_gate_4, docs_dev_gate_state_table_fingerprint_identity_rule [EXTRACTED 1.00]
- **P0 reliability & trust tier — the four accepted tracks** — docs_dev_engineering_recommendations_response_p0_trust_tier, docs_dev_atlas_engineering_recommendations_scale_provenance, docs_dev_atlas_engineering_recommendations_confidence_vector, docs_dev_atlas_engineering_recommendations_scene_health_gate, docs_dev_atlas_engineering_recommendations_atlas_project_manifest [EXTRACTED 1.00]
- **The New York Trilogy — One Photo, Three Problems** — docs_showcase_pdfs_atlas_wf_city_blocks_city_blocks_aerial_workflow, docs_showcase_pdfs_atlas_wf_dmp_anchored_dmp_anchored_walls_workflow, docs_showcase_pdfs_atlas_wf_dmp_xray_dmp_xray_workflow [EXTRACTED 1.00]
- **Merge-Chain Geometry Compositing Flow** — docs_showcase_pdfs_atlas_wf_composable_atlasdepthmap, docs_showcase_pdfs_atlas_wf_dmp_anchored_atlasderivewalls, docs_showcase_pdfs_atlas_wf_composable_atlasderivetowersspires, docs_showcase_pdfs_atlas_wf_composable_atlasderiveroofsfacades, docs_showcase_pdfs_atlas_wf_dmp_anchored_atlasmergegeometry, docs_showcase_pdfs_atlas_wf_composable_atlasexportnuke [EXTRACTED 1.00]
...
Cohesion: 0.05
Nodes (78): apply_interior_hole_fill(), boundary_edges(), _clip_once(), _cross2(), _directed_face_map(), _ear_clip(), fill_interior_holes(), _find_ear() (+70 more)

### Community 5 - "Animation Clip Loading"
Cohesion: 0.04
Nodes (80): addClip(), area(), Bd(), bM(), closePath(), CreateClipsFromMorphTargetSequences(), CreateFromMorphTargetSequence(), endOfContent() (+72 more)

### Community 6 - "WebGL Renderer Core"
Cohesion: 0.05
Nodes (66): addEventListener(), AS(), clear(), clearViewOffset(), connect(), constructor(), disconnect(), dispose() (+58 more)

### Community 7 - "Solver Benchmark Harness"
Cohesion: 0.08
...
### Community 22 - "App"
Cohesion: 0.07
Nodes (27): AnalysisPanel(), buildCameraSpec(), CameraSpec, confidenceTone(), countGuides(), DisplayVanishingPoint, emptyConstraints, formatMatrixValue() (+19 more)
...
Cohesion: 0.24
Nodes (19): extract_planes_ransac(), Any, Derive ground + any-orientation planes (+ backdrop) via sequential RANSAC     s, _require_numpy(), _by_prefix(), _ground_depth(), Tests for any-orientation RANSAC/Hough plane extraction (exteriors).  Self-conta, Analytic depth of an arbitrarily-oriented plane n·(p-p0)=0 plus ground. (+11 more)

### Community 26 - "Blockout Viewport Frontend"
Cohesion: 0.09
Nodes (31): atlasFitLongEdge(), atlasOutputProfileFromWidgets(), atlasReadRenderTargetAsBase64(), atlasRenderSceneToBase64(), atlasSetWidgetValue(), atlasViewportPreviewSize(), atlasViewportSizeTraceEnabled(), atlasWidget() (+23 more)

### Community 27 - "Geometry Attribute Computation"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (34): _allocateTargets(), am(), _applyGGXFilter(), _applyPMREM(), _blur(), _cleanup(), cm(), compileCubemapShader() (+26 more)
...
Cohesion: 0.20
Nodes (15): Best-effort map a scale cue to a scale-reference registry id., _resolve_reference_id(), Scale reference + camera-body registries for artist-guided solves., get_scale_reference(), list_categories(), load_scale_references(), Any, Local scale-reference registry. (+7 more)

### Community 67 - "Predicted Normal Alignment"
Cohesion: 0.19
...
Cohesion: 0.10
Nodes (21): applyAxisAngle(), applyEuler(), applyQuaternion(), clamp(), clampScalar(), compose(), getHex(), getHexString() (+13 more)

### Community 80 - "MCP HTTP Plumbing"
Cohesion: 0.11
Nodes (22): apply_overrides(), fetch_object_info(), gate_overrides(), http_json(), is_widget(), queue_and_wait(), HTTP + workflow plumbing for the Atlas MCP server.  The canonical home of the, Flatten a UI-format workflow to the API format ``/prompt`` executes. (+14 more)

### Community 81 - "Fixer Training Pairs"
Cohesion: 0.21
Nodes (19): _pair_dirs(), Tests for tools/generate_fixer_training_pairs.py (the Fixer fine-tune packaging, test_build_dataset_writes_fixer_manifest_with_interleaved_split(), test_build_dataset_zero_test_fraction(), test_collect_pairs_errors_on_orphans(), test_collect_pairs_matches_by_stem(), test_letterbox_preserves_aspect_and_pads_to_native(), test_resize_mode_writes_aligned_copies() (+11 more)

### Community 82 - "React Axis Grid"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (19): Atlas Engineering Recommendations (external review 2026-07-17), atlas_project.json versioned manifest, Fixed benchmark scene set + quantitative metrics, Three canonical workflows (Quickstart / Production / Research), Confidence vector (camera/focal/horizon/scale/depth/mask/hidden/reprojection), Product position: projection-scene authoring and review system, Scale provenance as a first-class object, Scene-health gate before export (recommendation) (+11 more)

### Community 89 - "Workflow Graph Generator"
Cohesion: 0.30
Nodes (12): Graph, learned_solve_node(), load_image_node(), main(), note_node(), Throwaway generator for the 3 retopology demo workflows.  Emits ComfyUI editor, relief_widgets(), viewport_node() (+4 more)

### Community 90 - "Generate Showcase Workflows"
Cohesion: 0.41
Nodes (14): build_city_blocks(), build_composable(), build_dmp_angle_anchored(), build_dmp_angle_xray(), build_ghosttown(), build_interior_hangar(), build_jungleruins(), build_ocio_dmp() (+6 more)

### Community 91 - "Test Scene Type Preset"
Cohesion: 0.12
Nodes (5): Tests for AtlasDeriveProjectionGeometry's scene_type convenience preset.  Only, test_derive_applies_preset_overrides_for_relief_quality_depth_edge_rel_and_max_objects(), test_preset_resolution_matches_derive_override_logic(), test_relief_quality_widget_exposed_with_custom_default(), test_scene_type_widget_exposed_with_manual_default()
...
Cohesion: 0.15
Nodes (14): Graph-integrity regression tests for every shipped example workflow.  ComfyUI', Every KJ GetNode's rail name must have exactly one SetNode — a renamed     or d, The per-layer previews + the 🔍 debug node live OUTSIDE every group     bounding, DMP seam doctrine (2026-07-12, from the quickstart's striped-seam     fix): at, v7 doctrine: 🎯 AtlasScopeMask rows self-disarm — none may ship     bypassed (mo, Every link must be listed by its origin output AND referenced by its     target, last_node_id / last_link_id must be >= every id in use — a stale     counter ma, _staged() (+6 more)

### Community 97 - "Api"
Cohesion: 0.28
Nodes (15): analyzeProject(), createProject(), exportCameraUsd(), exportReviewPackage(), loadLlmModels(), loadReferences(), ProjectPayload, promoteScaleCue() (+7 more)
...
Cohesion: 0.22
Nodes (14): estimate_ground_height_from_depth(), Measure camera height above the ground by fitting the ground plane in 3D., _flat_ground_depth(), Tests for depth-based camera-height measurement (fills the depth LatentComponent, Analytic z-depth of a flat ground plane Y=-height_m seen by a level camera., The >2MP stride-subsample branch (code-review Important #1): fresh     geometry, float32 input (no premature float64 copy) + an explicit horizon_y must     scal, Code-review Important #2: the disparity conversion is pure numpy and     must s (+6 more)

### Community 106 - "Test Atlas Input"
Cohesion: 0.22
...
Cohesion: 0.36
Nodes (14): _depth_result(), Tests for ground-anchored extrusion + roofline segmentation.  The premise (use, A near clutter band (car row) sharing the wall's azimuth must NOT     teleport, Ground plane + one fronto-parallel wall at z=-wall_z whose DEPTH is     optiona, _scene(), _solve(), test_banana_bias_recovered_by_ground_anchor(), test_flag_off_is_previous_behavior() (+6 more)

### Community 112 - "Test Mcp Comfy Http"
Cohesion: 0.20
Nodes (14): _out(), atlas_camera.mcp.comfy_http — the MCP server's stdlib workflow plumbing.  Pure, Every committed showcase/experimental workflow must at least parse and     reso, LoadImage → FakeSolve → SetNode rail → GetNode → Gate → FakeSink., test_bypassed_node_forwards_same_type_input(), test_gate_overrides_and_apply(), test_muted_producer_with_consumer_raises(), test_muted_terminal_node_drops() (+6 more)

### Community 113 - "Test Skyline Walls"
Cohesion: 0.37
Nodes (14): _depth_result(), Tests for skyline wall handling: distance-mode splitting within an azimuth peak, Ground plane + two fronto-parallel walls (SAME facing direction):     left imag, _solve(), test_classic_single_mode_collapses_same_azimuth_depths(), test_distance_modes_split_same_azimuth_into_depth_rows(), test_distance_modes_work_on_towers_spires_too(), test_exclude_mask_never_changes_ground_scale() (+6 more)

### Community 114 - "Viewport3dstate"
Cohesion: 0.25
Nodes (13): Constraints, LlmGuidance, addLlmScaleCandidates(), addProxyObject(), defaultViewport3DState, normalizeViewport3DState(), proxyPresets, selectedProxy() (+5 more)
...
Cohesion: 0.20
Nodes (14): v1 Outlier and Stretched-Edge Worklog (2026-07-18), AtlasDepthOutlierMask, AtlasInstanceMask, AtlasSDXLInpaint, AtlasSegmentedSDXLInpaint, Black-tear failure class, Median-depth world-edge budget, Orbit stress testing (+6 more)

### Community 121 - "Test Depth Estimator Da3"
Cohesion: 0.27
...
Cohesion: 0.26
Nodes (11): _fmt(), main(), torch availability + compute device. Skipped if torch absent., Zero-dep solve + export. No numpy / torch / image file required., All ComfyUI nodes must register with no heavy deps present., Geometric VP solve — numpy + opencv. Skipped if cv2 absent., tier_core(), tier_neural() (+3 more)

### Community 128 - "Viewport3dmath"
Cohesion: 0.29
Nodes (9): atlasIntrinsicsToThreeCamera(), atlasViewMatrixToWorldMatrix(), flattenMatrix4(), IntrinsicsLike, invertMatrix4(), multiplyMatrix4Vector(), projectPointToImage(), radiansToDegrees() (+1 more)
...
Cohesion: 0.47
Nodes (9): Convert a VLM scene observation into solver ``scale_references`` specs.      O, scale_references_from_observation(), SceneScaleCue, _obs(), Tests for wiring VLM scale cues into solver scale references.  The cue -> refere, test_maps_suggested_reference_id_and_label(), test_min_confidence_filter(), test_skips_cues_without_bbox_or_resolvable_height() (+1 more)

### Community 131 - "Test Moge Normals Node"
Cohesion: 0.46
...
Cohesion: 0.22
Nodes (8): _is_moge_model(), True for MoGe ids (e.g. ``Ruicheng/moge-2-vitl-normal``). MIT-licensed,     lig, MoGe-2 depth backend: id classification, dispatch routing, and (when the packag, A moge id must reach _estimate_depth_moge, never the V2 or DA3 paths., fov_x depends on the focal, so distinct focals must not share a cache entry., test_moge_cache_key_fragments_on_focal(), test_moge_dispatch_routes_by_model_id(), test_moge_model_id_classification()

### Community 134 - "Architecture"
Cohesion: 0.17
Nodes (12): Adapter Boundary Principle, Core Coordinate Conventions, Atlas Package Layer Architecture, Artist-Guided Constraint Solve, viewport3d UI-Only State, cam_y Below Ground Black Depth Failure, Maya .ma Export Findings, Verified-in-DCC Principle (+4 more)

### Community 135 - "Ecosystem Guide"
Cohesion: 0.20
Nodes (10): Bounded-Band Runaway-Relief Fix, GPL Graph-Level Boundary, Patch-View Horizon Fix, 2.5D Clean-Plate Parallax Layers, Multi-Angle Patch Projection, Safe Zone MVP Pivot, Deferred ONNX Depth Backend, Three Capability Tiers (+2 more)

### Community 136 - "Atlas Inpaint Layers Design"
Cohesion: 0.29
Nodes (10): Atlas Inpaint Layers — 2.5D Clean-Plate Parallax design (archived), AtlasCleanPlateLayer, AtlasDepthLayerMask, facingThreshold = -1 clean-plate branch, GPL boundary scope guard (graph composition, not linking), near_pct direction gotcha, Reuse ProjectionSource, don't invent schema, _resolve_depth_band shared helper (+2 more)

### Community 137 - "Atlas Mcp Server Plan"
Cohesion: 0.22
Nodes (10): Atlas v1 MCP Server design plan (archived, shipped), Atlas MCP server (atlas_camera/mcp), atlas://calibration knowledge resource, UI-to-API workflow flattening knowledge, Codex test drive of the Atlas MCP server (archived), Atlas Engineering Recommendations (archived external snapshot), Response to the project-wide stale-code report, AtlasLoadImageSolveCamera deprecation (+2 more)

### Community 138 - "Atlas Mesh Repair Solution"
Cohesion: 0.29
Nodes (10): Interior hole-fill on exported relief meshes (archived, shipped), Band-box depth window scope (fill_depth_near_m/far_m), Ear clipping replaces fan triangulation, Export-only mesh mutation doctrine, Interior hole fill (core/mesh_repair.py), Never-degrade fill contract, Pivot walk + pinch-vertex loop splitting, Export-Only Retopology (quad / decimate / smooth) (+2 more)

### Community 139 - "Atlas Wf Composable Pdf"
Cohesion: 0.24
Nodes (10): AtlasDepthMap, AtlasDeriveRoofsFacades, AtlasDeriveTowersSpires, AtlasExportNuke, Composable Geometry — The Merge Chain Workflow (temple city), Nuke-Style Merge-Chain Geometry Compositing, AtlasDeriveWalls, AtlasMergeGeometry (+2 more)

### Community 140 - "Atlas Wf Dmp Xray Pdf"
Cohesion: 0.29
Nodes (10): AtlasDepthLayerMask, AtlasPredictHiddenGeometry, DMP Angle Part 2 — X-Ray Workflow (Experimental), LaRI (Layered Ray Intersections), Restrict-Mask Discipline (Substitute Only Where the Occluder Is), AtlasRenderFix, LaRI Weak-Domain Honesty (Open Terrain), SAM3 Occluder Segment as restrict_mask (+2 more)

### Community 141 - "DccExporter"
Cohesion: 0.50
Nodes (3): DccExporter, Protocol, Common interface for single-output DCC script exporters.      Implemented by May

### Community 142 - "Test Semantic Segmenter"
Cohesion: 0.18
Nodes (15): available_labels(), _get_segformer(), match_class_ids(), Any, Semantic segmentation (SegFormer / ADE20K) for named-class masks.  A lightweig, The model's ADE20K label names (for no-match reports)., Resolve a comma-separated class query against ADE20K labels.      ADE labels a, Segment `image` (PIL) and return a bool mask covering `classes`.      Returns (+7 more)

### Community 143 - "Layers"
Cohesion: 0.43
Nodes (6): _load_constraints(), main(), _override_hints(), Namespace, Path, Solve one image from artist-guided constraints and build a review package.

### Community 144 - "Undistort"
Cohesion: 0.31
Nodes (8): apply_undistort(), build_undistort_map(), lensfun geometry correction for RAW imports ([raw-lens] extra).  Separate opti, EXIF make/model/lens -> lensfun profile -> remap grid.      The correction map, Remap one HxWx3 float32 array through the shared lensfun grid., _require_cv2(), _require_lensfunpy(), UndistortResult

### Community 145 - "Atlas Wf Oceancastle Pdf"
Cohesion: 0.28
Nodes (9): Atlas Showcase Field Guide, Gates Ship Closed Doctrine, tools/generate_showcase_workflows.py, AtlasExportNukeLayers, AtlasRegisterPlate, AtlasSkyDomeLayer, Farthest-Highest Layer Priorities (Seam Doctrine), OCIO Layered DMP — Ocean Castle Workflow (+1 more)

### Community 146 - "Atlas Wf Hangar Pdf"
Cohesion: 0.25
Nodes (9): Depth Model Doctrine (Exteriors V2-Outdoor, Interiors MoGe), AtlasAddPatchView, AtlasDeriveInteriorRoom, AtlasMogeNormals, AtlasSemanticMask, Decoupled MoGe Relight Normals, Interior Doctrine — Space Hangar Workflow, Render-Conditioned Patch Loop (Extract Angle Gated) (+1 more)

### Community 147 - "Atlas Wf Jungleruins Pdf"
Cohesion: 0.22
Nodes (9): AtlasBoundedBand, AtlasDeriveReliefMesh, AtlasExportBlender, AtlasExportReliefMesh, Canopy Doctrine (Fine Grid + Loose Edge Threshold), Export-Only Hole-Fill + Quad Retopology, Organic Relief + Retopo — Jungle Ruins Workflow, Absolute Band Split (Drift-Proof Two-Layer Boundary) (+1 more)

### Community 148 - "Test Debug Report"
Cohesion: 0.14
Nodes (19): atlas_y_up_to_blender_z_up(), atlas_y_up_to_maya_y_up(), default_extrinsics(), Extrinsics and coordinate-convention helpers., Convert an Atlas Y-up position to Blender-style Z-up position., Maya is also Y-up by default, so positions pass through unchanged., add_axis_guides(), create_default_projection_scene() (+11 more)

### Community 149 - "User Guide"
Cohesion: 0.43
Nodes (8): Examples Catalog Artifact, Layered Projection Build-Up Guide Artifact, Staged Master Operator's Guide Artifact, Technical Details Measurements Artifact, Published Artifact Sources, Shared DCC Layer Collection, AtlasInput One-Node Fast Path, Staged Master Workflow

### Community 150 - "Dcc Exports"
Cohesion: 0.33
Nodes (6): bg_xray Hidden-Geometry Layer, Nuke RenderCam Keyframing, X-ray Camera-Move Pipeline, Nuke Projection Topology, Root onScriptLoad Camera Wiring, Nuke TCL Path Corruption

### Community 151 - "User Guide"
Cohesion: 0.29
Nodes (8): Vendored Three.js Bundle, Recover-Derive-Project-Export Through-line, Realtime Navigable Viewport, Camera-Projection Texel Assignment, Matte-Painting Projection, Preview Dilation, Texels-by-Ray Depth Robustness, UV-Baked Projection Export

### Community 152 - "Three D"
Cohesion: 0.25
...
Cohesion: 0.43
Nodes (6): AtlasValidationError, Path, Lightweight validation helpers adapted from Maya2Comfy concepts., Raised when Atlas input or output validation fails., validate_directory_path(), validate_file_path()

### Community 157 - "Ecosystem Guide"
Cohesion: 0.29
Nodes (7): Guarded Inference Model Layer, Export-Only Interior Hole Fill, Five-Layer Projection Stack, Hidden-Geometry X-ray Track, 2.5D DMP Toolkit, Research Non-Commercial Tier, Viewport Diagnostics Toolbar

### Community 158 - "Project Vision"
Cohesion: 0.29
Nodes (7): LatentScene Schema Container, ProjectionSource Layer Model, Recover the Latent World, LatentCamera, Recover-Don't-Invent Philosophy, Version Milestones 0.1-3.0, Camera-Not-Mesh Thesis

### Community 159 - "Ecosystem Guide"
Cohesion: 0.33
Nodes (7): Elevated-Vista Scale Override Fix, Metric-Scale Honesty on AI Imagery, scale_health Trust Tier, Recovery Pipeline, Deterministic-First Solving, Two Solving Engines, Tiered Metric-Scale Cascade

### Community 160 - "Hidden Geometry Training Free Research"
Cohesion: 0.43
Nodes (7): Training-free hidden geometry research notes, Amodal Depth Anything (ICCV 2025), AtlasPredictHiddenGeometry (research-only X-ray node), LaRI — Layered Ray Intersections (ICML 2026), Layer-1 registration (pixel-aligned scale transfer), RaySt3R (2025), World Tracing — WT-DiT (2026)

### Community 161 - "Atlas Wf Portal Pdf"
Cohesion: 0.29
Nodes (7): AtlasDefineShotCam, AtlasDecomposeCamera, AtlasRollTrim, AtlasUSDCameraLoader, Roll Trim + Anamorphic Conform — Portal Workflow, Roll Trim by Eye (View-Axis Rotation), USD Camera Round-Trip Proof

### Community 162 - "Atlas Wf Solve Lab Pdf"
Cohesion: 0.38
Nodes (7): AtlasConstrainedSolve, AtlasReferenceScaleSolve, AtlasSolveFromImage, AtlasVLMScaleCues, AtlasVPVisualization, The Solve Lab Workflow (coastal alley), Three-Tier Metric Scale Ladder

### Community 163 - "Test Node Pack Entrypoint"
Cohesion: 0.33
Nodes (5): _load_as_custom_node(), The clone-and-go ComfyUI entry point (repo-root __init__.py): loading the repos, The beta-0.3 packaging audit found `include = ["atlas*"]` glob-matched     atla, test_package_discovery_cannot_swallow_runtime_dirs(), test_repo_root_loads_like_a_custom_node()

### Community 165 - "Atlas Viewport Edge Feather Idea"
Cohesion: 0.33
Nodes (6): Relief-mesh stretch diagnostics (stretch_ratio_p95 / stretch_fraction_gt12 / torn_fraction), Spatial diagnostics debug layers for inpainting and hidden geometry, Viewport edge feather GLSL design sketch, Boundary-distance vertex-attribute feather, Soft matte edge via dithered discard, Stretch fade (fwidth-based smear dissolve)

### Community 166 - "Atlas Occlusion Mask Implementation Plan"
Cohesion: 0.47
...
### Community 170 - "Paths"
Cohesion: 0.40
Nodes (3): ensure_directory(), Path, Path helpers for Atlas Camera.

### Community 171 - "Atlas Angle Patch Mvp"
Cohesion: 0.50
Nodes (5): Angle Patch MVP (Photoshop round trip, archived), AtlasExtractAnglePatch, AtlasImportAnglePatch, Full-frame paste-back registration rule, One-button Photoshop launch with OCIO (planned)

### Community 172 - "Fixer Finetune Data Plan"
Cohesion: 0.50
Nodes (5): Fixer fine-tune data plan, Fixer training-pair recipe (Atlas as degrader), Headless projection rendering (the one real build item), Parked / future development (FUTURE.md), Peak-RAM ceiling of the full band + inpaint pipeline (parked)

### Community 173 - "Atlas Wf City Blocks Pdf"
Cohesion: 0.50
Nodes (5): Sky-Rise Scale Doctrine (Count the Storeys), scene_type=aerial Preset, AtlasDeriveProjectionGeometry, AtlasExportMayaReviewScene, City Blocks Aerial Preset Workflow (New York)
...
### Community 176 - "Init"
Cohesion: 0.33
Nodes (6): Depth Anything 3 Backend, Atlas MCP Server, MCP Knowledge Resources, Thin-Translator Design, MCP v1 Tool Surface, Per-Scene Depth Model Choice

### Community 177 - "Third Party"
Cohesion: 0.83
Nodes (4): GPL Boundary (inpainting is graph-level only), Optional Inpaint Integration (graph-level GPL packs), comfyui-inpaint-nodes (LaMa/MAT, GPL-3.0), GPL Boundary (THIRD_PARTY statement)

### Community 178 - "Comfy Workflow"
Cohesion: 0.50
Nodes (4): Camera Data API Endpoint, Double-Import Route Guard, Render Passes Two-Pass Cycle, Two-Track Node Model

### Community 179 - "Dcc Exports"
Cohesion: 0.67
Nodes (4): Plate-Ref Color Management, ComfyUI-OCIO Output Integration, Float-Safe 8K Output Posture, Output Desk Proxy/Plate Split

### Community 180 - "Da3 Backend Test Plan"
Cohesion: 0.83
Nodes (4): DA3 backend test plan (V2 vs Depth Anything 3 A/B, archived), DA3 vs V2 A/B evaluation (compare_depth_backends), DA3 default flip decision (2026-07-09), DA3 default reversal on main (2026-07-13)

### Community 181 - "Scene Alpine Village Jpg"
Cohesion: 0.83
Nodes (4): Alpine Village Scene (Snowy Church Test Plate), Layered Depth Composition (FG Trees / Mid Village / BG Mountains / Sky), Leading Snow Road Perspective / Ground Plane Cue, Vertical Architecture as Camera-Solve Cue (Church Spire and Chalets)

### Community 182 - "Scene Canyon Jpg"
Cohesion: 0.83
Nodes (4): Cloaked Figure as Human Scale Reference, Elevated Vista Depth Layers (Foreground Ridge / Valley / Mountains / Sky), Hazy Atmospheric Horizon Camera-Solve Challenge, Canyon/Valley Vista Test Plate (scene_canyon.jpg)

### Community 183 - "Scene Cathedral Nave Jpg"
Cohesion: 0.67
Nodes (4): Cathedral Nave Test Plate, Gothic Cathedral Interior Scene, Skyless Interior Camera-Solve Test Case, One-Point Perspective Vanishing Geometry

### Community 184 - "Scene Ghost Town Jpg"
Cohesion: 0.67
Nodes (4): Natural Depth Layer Banding (Foreground Car / Mid Facades / Far Hills / Sky), Exterior Depth-Backend Test Plate (Ghost-Town A/B Scene), Ghost Town Scene Plate, One-Point Perspective Street Corridor

### Community 185 - "Scene Jungle Temple Jpg"
Cohesion: 0.83
Nodes (4): Dense Jungle Canopy and Foreground Foliage Occlusion, Hidden-Horizon Eye-Level Camera Test Case, Jungle Temple Scene Plate, Overgrown Khmer-Style Temple Ruins

### Community 186 - "Scene Monument Valley Jpg"
Cohesion: 0.83
Nodes (4): Desert Butte Terrain (Layered Depth Landscape), Foreground Boulder and Long Shadow Scale Cues, Clear Horizon Line and Twilight Sky Gradient, Monument Valley Scene Plate

### Community 187 - "Scene Mountain Ridge Figure Jpg"
Cohesion: 0.67
Nodes (4): Clear Horizon and Gradient Sky Separation, Elevated Vista Depth Layers (Foreground Ridge to Hazy Valley), Human Figure as Scale Reference, Mountain Ridge Figure Scene Plate

### Community 188 - "Scene Scifi Hangar Jpg"
Cohesion: 0.83
Nodes (4): Depth-Layered Hangar With Foreground Spaceship Subject, Interior Scene With No Sky, One-Point Perspective Corridor Geometry, Sci-Fi Hangar Test Plate (scene_scifi_hangar.jpg)

### Community 189 - "Scene Seacliff Castle Jpg"
Cohesion: 0.83
Nodes (4): Coastal Castle Architecture (Towers and Spires), Foreground Cliff / Mid Castle / Far Sea Depth Layers, Ocean Horizon Line and Sky Band, Seacliff Castle Scene Plate

### Community 190 - "Scene Snowcapped Peaks Jpg"
Cohesion: 0.67
Nodes (4): Atmospheric Depth Layering (Receding Ridgelines), Elevated Mountain Vista Scale Ambiguity, No True Horizon / Diagonal Ridge Solve Challenge, Snowcapped Peaks Scene Plate

### Community 191 - "Scene Steep Ridge Jpg"
Cohesion: 0.83
Nodes (4): Steep Ridge Scene Plate (scene_steep_ridge.jpg), Atmospheric Haze Depth Layers, No-True-Horizon Camera Solve Challenge (diagonal ridge lines), Steep Alpine Ridge Scene (hazy layered mountain vista)

### Community 192 - "Scene Wide Valley Jpg"
Cohesion: 0.83
Nodes (4): Camera-Solve Characteristics: clean flat horizon, eye-level outdoor camera, rippled Y=0 ground plane for ground fit, smooth gradient sky ideal for sky masking, no scale reference (assumed-default height risk), Depth Layering Cues: foreground boulder with long cast shadow, mid-ground monolith cluster, distant spires, far horizon, Wide Valley Test Plate (Monument-Valley Desert at Golden Hour), Wide Valley Scene Concept: layered desert vista with buttes, flat ground plane, gradient sky

### Community 193 - "Mcp"
Cohesion: 0.50
Nodes (3): COMFY_HOST, python, atlas

### Community 194 - "Atlas Camera Icon Png"
Cohesion: 1.00
Nodes (3): Atlas Camera Icon, AtlasCamera Project Branding, Camera Crosshair Reticle Motif

### Community 195 - "Ecosystem Guide"
Cohesion: 0.67
Nodes (3): Automatic Photo Pop-up (Hoiem/Efros/Hebert, SIGGRAPH 2005), Primitive-Fitting Strategy Family, Sky-Aware Depth Masking

### Community 196 - "Publish Comfyui Registry Yml"
Cohesion: 0.67
