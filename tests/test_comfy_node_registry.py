...
NORMAL_KEYS = {
    ...
    "AtlasLayerPreview", "AtlasLearnedSolveFromImage",     "AtlasFaceScaleReference", "AtlasLoadRAW", "AtlasLoadRecord3D", "AtlasLoadSolveJSON", "AtlasMergeGeometry", "AtlasMogeNormals",
...
def test_normal_registry_keys_exact():
    ...
    assert len(nodes.NODE_CLASS_MAPPINGS) == 85
