...
atlas_camera.comfy      � ComfyUI node library (91 standard + 6 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (91 standard + 6 experimental + 2 legacy + 2 iOS = 101
...
- Registered node keys + display names are a saved-workflow contract
  (`tests/test_comfy_node_registry.py` pins the surface; currently 91 standard
