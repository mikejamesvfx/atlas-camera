...
atlas_camera.comfy      � ComfyUI node library (114 standard + 10 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (114 standard + 10 experimental + 2 legacy + 2 iOS = 128
...
- Registered node keys + display names are a saved-workflow contract
  (`tests/test_comfy_node_registry.py` pins the surface; currently 114 standard
