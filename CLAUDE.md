...
atlas_camera.comfy      � ComfyUI node library (90 standard + 6 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (90 standard + 6 experimental + 2 legacy + 2 iOS = 100
...
- Registered node keys + display names are a saved-workflow contract
  (`tests/test_comfy_node_registry.py` pins the surface; currently 90 standard
