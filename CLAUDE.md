...
atlas_camera.comfy      � ComfyUI node library (99 standard + 7 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (99 standard + 7 experimental + 2 legacy + 2 iOS = 110
...
- Registered node keys + display names are a saved-workflow contract
  (`tests/test_comfy_node_registry.py` pins the surface; currently 99 standard
