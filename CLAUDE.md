...
atlas_camera.comfy      � ComfyUI node library (93 standard + 6 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (93 standard + 6 experimental + 2 legacy + 2 iOS = 103
