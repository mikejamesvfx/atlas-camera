...
atlas_camera.comfy      � ComfyUI node library (115 standard + 10 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (115 standard + 10 experimental + 2 legacy + 2 iOS = 129
...
- Registered node keys + display names are a saved-workflow contract
  (`tests/test_comfy_node_registry.py` pins the surface; currently 115 standard
