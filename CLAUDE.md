...
| `AtlasBlockoutViewport` | ATLAS_SOLVE, source_image, resolution, client_data | shaded, depth, normal, mask (all IMAGE) | OUTPUT_NODE; browser-side Three.js. `resolution` = long edge; W×H auto-follows source image aspect. Render Passes button populates client_data |
