...
atlas_camera.comfy      � ComfyUI node library (100 standard + 6 experimental + 2 legacy + 2 iOS, no hard Comfy dep;
...
The full node catalog (100 standard + 6 experimental + 2 legacy + 2 iOS = 110
