...
solve, source_image, target_width: int, target_height: int,
                              ...
                              primary_depth=None, debug_matte_b64: str = "",
                              patch_mask_b64: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        # Exact source-image-space pixels whose relief cells were generated by
        # AtlasPlanarHolePatch.  The viewport reprojects this through the
        # recovered camera for both the 🎨 layer overlay and the moved-camera
        # patch_render_mask proxy pass.
        "patch_mask_b64": patch_mask_b64 or "",
    }
